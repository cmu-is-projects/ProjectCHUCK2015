...
include Activeable
  ...
  validates_date :dob, :on_or_before => lambda { 6.years.ago.to_date }, :on_or_after => lambda {18.years.ago.to_date}, :on_or_after_message => " (Date of birth) must be betweeen ages of 6 and 18", :on_or_before_message => "must be betweeen ages of 6 and 18"
