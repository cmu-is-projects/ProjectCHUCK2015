...
include Activeable
  ...
  validates_presence_of :first_name, :last_name, :role, :dob, :street, :city, :state, :zip, :day_phone, :years_with_proj_chuck, :cell_phone, :email, :shirt_size#, :act33_clearance, :act34_clearance, :act153_clearance#, :volunteer_sign
